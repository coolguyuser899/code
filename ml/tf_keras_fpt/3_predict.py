...
ap.add_argument("-image" "--image", type=str, default='test.jpg', help="Parth of test image")
...
x = base_model.output
x = Dense(128)(x)    # 128 dimensionality of the output space
...
inputShape = (224, 224) #3 channel image
image = load_img(args["image"], target_size=inputShape)
image = img_to_array(image)   #shape is 224, 224, 3
image = np.expand_dims(image, axis = 0)  #now shage is (1, 224, 224, 3)
